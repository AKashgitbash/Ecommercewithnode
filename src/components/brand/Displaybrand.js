...
export default function Displayformat(props) {
  ...
  const handelEdit = (rowData) => {
    ...
    setpicture({
      fileBytes: "",
      fileUrl: `${ServerURL}/images/${rowData.picture}`,
    });
        ...
        <DialogContent>
          <DialogContentText>
            <Grid container spacing={3} style={{ marginTop: "-50px" }}>
              ...
              <Grid item xs={12} style={{ marginRight: "21px" }}>
              ...
              <Grid item xs={12}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  fullWidth
                  onChange={(event) => brandname(event)}
                />
              </Grid>
              <Grid item xs={12}>
              ...
              <Grid item xs={3} style={{ marginTop: "26px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <div
                    style={{ padding: "3px", marginLeft: "20px", width: "20%" }}
                  >
                    {getsavepicture ? (
                      <Button
