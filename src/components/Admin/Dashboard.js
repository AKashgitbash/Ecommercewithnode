...
import { ServerURL } from '../FetchNodeservice';
...
export default function Dashboard(props) {
  ...
  const [getView,setView]=useState(<Category/>)
    ...
    <div className={classes.root}>
      ...
      <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          {getAdmin?<Avatar alt="Admin" src={`${ServerURL}/images/${getAdmin[0].picture}`} className={classes.large} />:<></>}
          </IconButton>
        </Toolbar>
      </AppBar>
      <Drawer
