...
import {postData,postDataAndImage,ServerURL,getData} from "../FetchNodeservice"
...
export default function AdminLogin(props) {
  ...
  const Submit=async()=>{
        ...
        var body = {EmailId:getEmailId,Password:getPassword}
  ...
  <h2><font color="#d35400">{getMsg}</font></h2>
            <Grid container>
              <Grid item xs>
