    ...
    if (!err) {
      if (getGOTP == getOTP) {
        ...
        if (result) {
          ...
          //  props.history.push({pathname:`/ShowCartWithAddress`},{'data':getUser.DATA,'mobileno':props.location.state});
        } else {
        ...
        >
          <Grid container>
            <Grid item xs={12} sm={6}>
              <img src="/jhanvi2.jpg" style={{ borderRadius: 10 }} width='97%' height='100%' />
            </Grid>
            <Grid item xs={12} sm={6}>
