...
import { getData,ServerURL,postData} from '../FetchNodeservice';
        ...
        let body={address1:getAddress1,
             ...
             var result= await postData('userdetails/addAddress',body)  
                if(result.RESULT)
                {
                  ...
                  dispatch({type:"ADD_USER",payload:[getUserData[0].mobileno,user.DATA]});
...
*/
  //dispatch({type:"ADD_USER",payload:[getUserData[0].mobileno,getUserData[0]]})
